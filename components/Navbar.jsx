...
const Navbar = () => {
  ...
  return (
    <nav className='absolute top-0 left-0 right-0 w-screen  md:top-7 md:left-5 md:right-6 md:w-auto bg-white z-11 p-4 border-1 border-gray-300 shadow'>
        <div className="w-full h-10 md:h-25 flex items-center justify-between">
          
          {/* Mobile: Button on Left */}
          <button className="flex flex-row hover:text-black items-center bg-white text-gray-700 px-4 py-2 w-38 ml-2 h-10 border-2 border-gray-700 md:hidden ">
